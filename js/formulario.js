...
const validarCampo = (expresion, input, campo) => {
  if (expresion.test(input.value)) {
    document
      ...
      .classList.remove("fomulario__grupo-incorrecto");
    document
      .getElementById(`grupo__${campo}`)
      .classList.add("fomulario__grupo-correcto");
    document
    ...
    document
      .getElementById(`grupo__${campo}`)
      .classList.add("fomulario__grupo-incorrecto");
    document
      .getElementById(`grupo__${campo}`)
      .classList.remove("fomulario__grupo-correcto");
    document
      .querySelector(`#grupo__${campo} i`)
      .classList.add("fa-circle-xmark");
    document
